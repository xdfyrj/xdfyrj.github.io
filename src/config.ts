...
export const siteConfig: SiteConfig = {
  ...
  themeColor: {
    hue: 250,//185,         // Default hue for the theme color, from 0 to 360. e.g. red: 0, teal: 200, cyan: 250, pink: 345
...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/space.png',//profile.jpg,  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'xdfyrj',
